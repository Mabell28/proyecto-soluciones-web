...
class Reportes
{
	...
	{
		$query = "SELECT (compra_detalle.precio*compra_detalle.cantidad) AS total, 
							compra.fecha AS fecha, producto.id AS id_producto, producto.nombre AS nombre_producto 
