...
<body>
	...
	<section class="container-fluid mg-section" id="categoria-i">
		...
		<div class="row">
			<div class="col-sm-4 pd-0">
				...
				<h5 class="text-center">Blusas para Mujer</h5>
				<div class="hover">
			...
			<div class="col-sm-4 pd-0">
				...
				<h5 class="text-center">Jeans para Hombre</h5>
				<div class="hover">
					<div class="box-button">
							<button type="button" class="btn btn-info btn-lg btn-hover"><a href="productos-hombre.php">VER MÁS</a></button>
						</div>
				</div>
			</div>
			<div class="col-sm-4 pd-0">
				...
				<h5 class="text-center">Polo para Hombre</h5>
				<div class="hover">
					<div class="box-button">
							<button type="button" class="btn btn-info btn-lg btn-hover" data-toggle="modal" data-target="#myModal"><a href="productos-hombre.php">VER MÁS</a></button>
						</div>
				</div>
			</div>
		</div>
	...
	<section class="container" id="prom-index">
	</section>
